  ...
  Widget build(BuildContext context) {
    List<Widget> children = [
      ...
      SovendusBanner(
        ...
        // Optional error callback for handling errors
        onError: (errorMessage, error) {
          // Handle errors here - could send to analytics, show user notification, etc.
          print('Sovendus Error: $errorMessage - $error');
        },
      ),
      colDivider,
      const Actions(),
